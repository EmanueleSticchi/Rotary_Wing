...
figure;
plot(s.mu,s.theta0*180/pi,'-k');
hold on

figure;
plot(s.mu,s.alpha_TPP_Vec*180/pi,'-k');
hold on

figure;
plot(s.mu,s.lam_Vec,'-k');
hold on
plot(s.mu,s.lam_i,':k');
plot(s.mu,s.lam_c,'.-k');

figure;
plot(s.mu,s.beta0_Vec*180/pi,'-k');
hold on
plot(s.mu,s.beta1c_Vec*180/pi,':k');
plot(s.mu,s.beta1s_Vec*180/pi,'.-k');
